  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center bg-gray-800 text-white py-16">
      <div ref={ref} className={`container mx-auto px-6 text-center max-w-4xl transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
        <h2 className="text-4xl md:text-5xl font-extrabold text-blue-400 mb-12">Get In Touch</h2>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-8">
          ...
          >
            ...
            <p className="text-xl font-semibold text-white group-hover:text-blue-400 transition-colors duration-300">Email</p>
          </a>
          <a
            href={contact.github}
            className="flex flex-col items-center p-6 bg-gray-900 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 border border-gray-700 group"
          ...
          >
            ...
            <p className="text-xl font-semibold text-white group-hover:text-blue-400 transition-colors duration-300">GitHub</p>
          </a>
          <a
          ...
          >
            ...
            <p className="text-xl font-semibold text-white group-hover:text-blue-400 transition-colors duration-300">LinkedIn</p>
          </a>
        </div>
      </div>
    </section>
